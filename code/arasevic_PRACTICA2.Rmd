...
Por otra parte, las columnas "parking", "balcony", "terrace", "elevator", "heating", "swimming_pool" y "air_conditioner" tienen significado binario: si la variable está informada, la propiedad está equipada con la característica, carece de ella si no está informada. Utilizamos la función `as.logical()` para facilitar su tratamiento:
